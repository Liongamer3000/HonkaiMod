...
@OnlyIn(Dist.CLIENT)
public class EdenstarEffectParticles5 extends TextureSheetParticle {
    ...
    protected EdenstarEffectParticles5(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double pXSpeed, double pYSpeed, double pZSpeed) {
...
*/
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ,
            ...
            EdenstarEffectParticles5 particles = new EdenstarEffectParticles5(pLevel, pX, pY, pZ,this.spriteSet, pXSpeed, pYSpeed, pZSpeed);
