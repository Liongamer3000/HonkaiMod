...
@OnlyIn(Dist.CLIENT)
public class EdenstarEffectParticles2 extends TextureSheetParticle {
    ...
    protected EdenstarEffectParticles2(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double pXSpeed, double pYSpeed, double pZSpeed) {
        ...
        this.speedY = pYSpeed;
        this.speedZ = pZSpeed;
        this.setSize((float) (Math.random() * 10f), (float) (Math.random() * 10f));
...
*/
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ,
            ...
            EdenstarEffectParticles2 particles = new EdenstarEffectParticles2(pLevel, pX, pY, pZ,this.spriteSet, pXSpeed, pYSpeed, pZSpeed);
