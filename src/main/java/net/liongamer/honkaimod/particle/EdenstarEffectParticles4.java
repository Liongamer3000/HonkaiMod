...
@OnlyIn(Dist.CLIENT)
public class EdenstarEffectParticles4 extends TextureSheetParticle {
    ...
    protected EdenstarEffectParticles4(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double pXSpeed, double pYSpeed, double pZSpeed) {
        ...
        this.speedY = pYSpeed;
        this.speedZ = pZSpeed;
        this.setSize((float) (Math.random() * 1.5f), (float) (Math.random() * 1.5f));
...
*/
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ,
            ...
            EdenstarEffectParticles4 particles = new EdenstarEffectParticles4(pLevel, pX, pY, pZ,this.spriteSet, pXSpeed, pYSpeed, pZSpeed);
